...
HD_PWD='C:/Speedway/ZynqHW/2017_1/ZynqDesign/ZynqDesign.runs/Z_system_PWM_w_Int_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Z_system_PWM_w_Int_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Z_system_PWM_w_Int_0_0.tcl
