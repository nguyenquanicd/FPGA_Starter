...
HD_PWD='F:/Demo/Demo.runs/Demo_rst_ps7_0_50M_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo_rst_ps7_0_50M_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demo_rst_ps7_0_50M_2.tcl
