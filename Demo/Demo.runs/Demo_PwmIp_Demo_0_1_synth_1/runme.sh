...
HD_PWD='F:/Demo/Demo.runs/Demo_PwmIp_Demo_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo_PwmIp_Demo_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demo_PwmIp_Demo_0_1.tcl
