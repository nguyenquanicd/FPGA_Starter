...
HD_PWD='F:/Demo/Demo.runs/Demo_util_reduced_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Demo_util_reduced_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Demo_util_reduced_logic_0_0.tcl
