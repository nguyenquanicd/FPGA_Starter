...
proc create_root_design { parentCell } {
  ...
  # Create instance: PwmIp_Demo_0, and set properties
  set PwmIp_Demo_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:PwmIp_Demo:1.0 PwmIp_Demo_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {2.000000} \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR0 {28} \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {2} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins PwmIp_Demo_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net PwmIp_Demo_0_Interrupt [get_bd_ports PL_LED_R] [get_bd_pins PwmIp_Demo_0/Interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net PwmIp_Demo_0_PWM_out [get_bd_pins PwmIp_Demo_0/PWM_out] [get_bd_pins util_reduced_logic_0/Op1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PwmIp_Demo_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PwmIp_Demo_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net util_reduced_logic_0_Res [get_bd_ports PL_LED_G] [get_bd_pins util_reduced_logic_0/Res]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PwmIp_Demo_0/S00_AXI/S00_AXI_reg] SEG_PwmIp_Demo_0_S00_AXI_reg
