...
HD_PWD='f:/demo/demo.tmp/pwmip_demo_v1_0_project/PwmIp_Demo_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PwmIp_Demo_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PwmIp_Demo_v1_0.tcl
