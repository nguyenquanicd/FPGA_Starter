...
HD_PWD='f:/demo/demo.tmp/pwmip_demo_v1_0_project/PwmIp_Demo_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PwmIp_Demo_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PwmIp_Demo_v1_0.tcl -notrace
