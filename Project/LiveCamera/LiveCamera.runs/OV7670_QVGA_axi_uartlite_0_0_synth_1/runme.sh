...
HD_PWD='F:/Git_Fpga/FPGA_Starter/Project/LiveCamera/LiveCamera.runs/OV7670_QVGA_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_QVGA_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7670_QVGA_axi_uartlite_0_0.tcl
